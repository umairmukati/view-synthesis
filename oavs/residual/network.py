...
from functions import get_variable, get_numpy, img_diff, img_show, img_disp
...
class Net(nn.Module):
    ...
    def __init__(self, input_shape, minibatch_size, lfsize, batchAffine = False, bias = False):
        ...
        self.r_conv6 = nn.Conv2d(64,  3,   kernel_size = 3, padding = 1, bias = bias)
    ...
    def forward(self, x, p, q):
        ...
        R = self.rcnn(torch.cat((F_00, F_01, F_10, F_11, R_00, R_01, R_10, R_11, d, self.P, self.Q), 1))
