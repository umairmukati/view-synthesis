...
for ns = 1 : numScenes
    ...
    fprintf('------------------------------\n');
    [pInImgs, pRef, refPos] = ComputeTrainingExamples(curFullLF, curInputLF);
    
    fprintf('\nWriting training examples\n\n');
    firstBatch = WriteTrainingExamples(pInImgs, pRef, refPos, outputFolder, writeOrder, (ns-1) * numPatches * param.numRefs + 1, firstBatch, numTotalPatches);
